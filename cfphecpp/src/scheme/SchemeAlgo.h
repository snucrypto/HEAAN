...
public:
	...
	vector<Cipher> fftNew(vector<Cipher>& ciphers, vector<Ksi>& ksis, ZZ& factor, long bnd);
	vector<Cipher> fftInvNew(vector<Cipher>& ciphers, vector<Ksi>& ksis, ZZ& factor, long bnd);
};
