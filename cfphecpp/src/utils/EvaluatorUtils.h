...
public:
	...
	static CZZ evaluateProd2(const double& xr, const double& xi, const long& logDegree, const long& logp);
	...
	static vector<CZZ> evaluateProd2vec(const double& xr, const double& xi, const long& logDegree, const long& logp);
